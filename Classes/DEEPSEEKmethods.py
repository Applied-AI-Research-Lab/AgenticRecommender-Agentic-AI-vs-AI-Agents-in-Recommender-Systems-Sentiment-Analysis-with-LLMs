...
class DEEPSEEKmethods:
    def __init__(self, params):
        ...
        """
        # Access the DEEPSEEK API key from config file (loaded from .env)
...
# params['model_id'] = 'deepseek-chat'  # DeepSeek-V3.2-Exp (Non-thinking Mode)
# params['prediction_column'] = 'deepseek-chat_prediction'

# params['model_id'] = 'deepseek-reasoner'  # DeepSeek-V3.2-Exp (Thinking Mode)
# params['prediction_column'] = 'deepseek-reasoner_prediction'

# === DeepSeek Model Family ===
# DeepSeek Chat:
#   • DeepSeek-V3.2-Exp in Non-thinking Mode.
#   • Optimized for straightforward chat and retrieval tasks.
#
# DeepSeek Reasoner:
#   • DeepSeek-V3.2-Exp in Thinking Mode.
#   • Designed for reasoning, problem solving, and more complex workflows.
#

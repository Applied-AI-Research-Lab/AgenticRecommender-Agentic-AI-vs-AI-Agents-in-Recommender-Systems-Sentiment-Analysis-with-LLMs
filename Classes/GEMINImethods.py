...
class GEMINImethods:
    def __init__(self, params):
        ...
        """
        # Access the GEMINI API key from config file (loaded from .env)
    ...
    def gemini_prediction(self, input):
        conversation = self.generate_prompt(feature=input['title'] + '\n' + input[self.feature_col])
...
"""
params = {
    'model_id': 'gemini-2.5-pro',  # Specifies the GEMINI model ID for making predictions.
    'prediction_column': 'gemini-2.5-pro_prediction',  # Specifies the column where predictions will be stored.
...
# params['prediction_column'] = 'gemini-2.5-pro_prediction'

# params['model_id'] = 'gemini-2.5-flash'
# params['prediction_column'] = 'gemini-2.5-flash_prediction'

# params['model_id'] = 'gemini-2.5-flash-lite'
# params['prediction_column'] = 'gemini-2.5-flash-lite_prediction'

# === Gemini 2.5 Model Family ===
# Gemini 2.5 Pro:
#   • Our state-of-the-art reasoning model for complex tasks in code, math, and STEM.
#   • Excels at analyzing large datasets, codebases, and documents using long context.
#
# Gemini 2.5 Flash:
#   • Best price-performance balance with well-rounded capabilities.
#   • Ideal for large-scale processing, low-latency, high-volume, and agentic use cases.
#
# Gemini 2.5 Flash-Lite:
#   • Fastest and most cost-efficient Flash variant.
#   • Optimized for high throughput and lightweight workloads.
#
# --- Pricing ---
# Gemini 2.5 Pro:

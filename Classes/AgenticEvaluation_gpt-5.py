...
class AgenticEvaluation:
    def __init__(self, csv_path: str):
        ...
        self.orchestrator = 'gpt-5-2025-08-07_agentic_prediction'
    ...
    def compare_orchestrator_vs_gpt5(self):
        """Compare orchestrator predictions with GPT-5 baseline.
        
        Returns:
            dict: Contains:
            - 'Total Changes': Number of times the orchestrator changed the GPT-5 prediction.
            - 'Improved Accuracy': Number of changes that led to correct predictions (when GPT-5 was wrong).
            - 'Worsened Accuracy': Number of changes that led to incorrect predictions (when GPT-5 was right).
            This analyzes how the orchestrator modifies the standalone GPT-5 model.
        """
        gpt5 = 'gpt-5_prediction'
    ...
    def analyze_influences(self) -> pd.DataFrame:
        ...
        Returns:
            ...
            Analyzes influence when the orchestrator changes from the GPT-5 baseline.
        """
        gpt5 = 'gpt-5_prediction'
    ...
    def compare_orchestrator_vs_standalone(self):
        ...
        """
        standalone = 'gpt-5_prediction'  # Assuming this is the standalone
        orch = self.orchestrator
        y_true = self.df[self.true_label]
    ...
    def run_all_analyses_and_save(self, output_file: str = 'Results/results.txt'):
        """Run all analyses and save results to file with research questions."""
        with open(output_file, 'w') as f:
            f.write("Research Questions and Results\n\n")
...
if __name__ == "__main__":
    ...
    evaluator.run_all_analyses_and_save('Results/results-gpt-5-as-orchestrator.txt')
    print("All analyses completed and saved to Results/results-gpt-5-as-orchestrator.txt")